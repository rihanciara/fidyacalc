...
export const translations = {
  en: {
    ...
    calculationBreakdown: "How Calculated",
    methodUsed: "Method Used",
    breakdownTitle: "Current Calculation Breakdown",
    historicalTotals: "Historical Totals",
    conversionSteps: "Conversion Steps",
    futurePlanMath: "Future Plan Math",
    perRowDetails: "Per Input Details",
    row: "Row",
    period: "Period",
    yearsDelayed: "Years Delayed",
    noDelayYet: "No delay penalty yet",
    year: "Year",
  ...
  ml: {
    ...
    calculationBreakdown: "കണക്കാക്കിയത് എങ്ങനെ",
    methodUsed: "ഉപയോഗിച്ച രീതി",
    breakdownTitle: "ഇപ്പോഴത്തെ കണക്കിന്റെ വിശദീകരണം",
    historicalTotals: "മുമ്പത്തെ ആകെ കണക്കുകൾ",
    conversionSteps: "പരിവർത്തന ഘട്ടങ്ങൾ",
    futurePlanMath: "ഭാവി പ്ലാൻ ഗണിതം",
    perRowDetails: "ഓരോ ഇൻപുട്ടിന്റെയും കണക്ക്",
    row: "നിര",
    period: "കാലഘട്ടം",
    yearsDelayed: "വൈകിയ വർഷങ്ങൾ",
    noDelayYet: "ഇപ്പോൾ വരെ വൈകിയിട്ടില്ല",
    year: "വർഷം",
